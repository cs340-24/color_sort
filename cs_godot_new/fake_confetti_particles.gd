...
@export var random_amount: bool = false
...
@export var visibility_rect: Rect2 = Rect2(0.0, 0.0, 500.0, 500.0)
...
@export var timer_wait_time: float = 0.75
...
func _create_particles():
	...
	if random_position:
		...
		particles_position = Vector2(300, 200)
