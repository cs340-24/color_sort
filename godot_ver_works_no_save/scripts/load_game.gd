...
var welcome
var game
var game_filename = "res://input_files/levelData/demo.txt"
var welcome_screen = preload("res://scenes/welcome_screen.tscn")
var help_screen = preload("res://scenes/help_scroll.tscn")
var help_var
...
func clear_help_screen():
	call_deferred("_deffered_clear_help_screen")

func _deffered_clear_help_screen():
	help_var.free()
