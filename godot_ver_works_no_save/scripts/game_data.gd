...
var color_filename = "res://input_files/colors.txt"
var bottles_scene = preload("res://scenes/level.tscn")
var game_screen = preload("res://scenes/game.tscn")
var win_msg = preload("res://scenes/new_win.tscn")
